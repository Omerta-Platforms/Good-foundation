...
const mockResult = {
  ...
  subjects: [
    ...
    { name: 'English Language', score: 72, grade: 'B', remark: 'Very Good' },
    { name: 'Physics', score: 78, grade: 'B', remark: 'Very Good' },
    { name: 'Chemistry', score: 65, grade: 'C', remark: 'Good' },
    { name: 'Biology', score: 70, grade: 'B', remark: 'Very Good' },
    { name: 'Further Mathematics', score: 55, grade: 'C', remark: 'Good' },
    { name: 'Economics', score: 68, grade: 'B', remark: 'Very Good' },
    { name: 'Government', score: 60, grade: 'C', remark: 'Good' },
  ],
  total: 553,
  average: 69.13,
  position: 15
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-gray-800 dark:text-gray-200">{result.position}</p>
                      </div>
